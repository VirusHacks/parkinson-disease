...
- A focused tremor-task policy search with saved artifacts in:
  - `outputs/tremor_policy_search.json`
  - `outputs/tremor_policy_search.md`

## Current benchmark snapshot

Source of truth:

- `outputs/benchmark_eval.json`
- `outputs/benchmark_eval.md`
- `outputs/tremor_policy_search.json`
- `outputs/tremor_policy_search.md`
...
- `parkinsons_Motor/eval_suite.py`
- `parkinsons_Motor/tremor_policy_search.py`
