"""
Search simple tremor-rescue baseline settings and store the results.

The goal is not to find a perfect controller, but to identify a clinically
reasonable operating region that beats passive treatment without relying on
unsafe brute-force stimulation.
"""
